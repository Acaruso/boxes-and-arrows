...
class Box {
    constructor(text, coord, id=0) {
        ...
        this.charHeight = textConstants.charHeight;
        this.charWidth = textConstants.charWidth;
        // this.xPadding = 4;
        // this.yPadding = 6;
        this.xPadding = textConstants.xPadding;
        this.yPadding = textConstants.yPadding;
        this.text = text;
        this.rect = {};
